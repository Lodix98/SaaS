...
export function DashboardGrid({
  ...
  const statCards = [
    ...
    { label: "Awaiting Docs", value: stats.awaitingDocs, icon: Clock, color: "text-yellow-500" },
    { label: "Complete", value: stats.complete, icon: CheckCircle, color: "text-emerald-500" },
    ...
    return (
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">{formatMonth(currentMonth)}</p>
        </div>
        <Card>
            ...
            <Card key={card.label}>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className={cn("p-3 rounded-full bg-accent", card.color)}>
